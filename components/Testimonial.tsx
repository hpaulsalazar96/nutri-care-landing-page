                        ...
                        <div className="flex flex-col w-full pt-16">
                            <ScrollAnimationWrapper className={""}>
                                <motion.h3
                                    ...
                                    className="text-2xl sm:text-3xl lg:text-4xl font-medium text-nutricare-200 leading-normal w-9/12 sm: lg:w-4/12 mx-auto">
                                    Testimonios{" "}
                                </motion.h3>
                                <motion.p
                                    variants={scrollAnimation}
                            ...
                            <motion.div variants={scrollAnimation}>
                                {
                                    !smallScreen
                                        ...
                                        (<>
                                            ...
                                            <div className="relative rigth-15 flex w-full items-center justify-center pt-2">
                                                <div className="absolute flex justify-center w-auto mt-14">
                                                    <div
                                                        className="mx-4 flex items-center justify-center h-14 w-14 rounded-full bg-white border-nutricare-100 border hover:bg-nutricare-200 hover:text-white-500 hover:border-nutricare-200 transition-all text-nutricare-100 cursor-pointer"
                                                        onClick={sliderRef?.slickPrev}
                                                    >
