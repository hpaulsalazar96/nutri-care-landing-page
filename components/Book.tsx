...
export const Booking = () => {
    ...
    return (
        <>
            <div className="bg-gradient-to-b from-white-500 to-white-500 w-full py-16 pt-32 pb-32 mb-12 mt-12" id="book">
            ...
            {
                active && (
                    <div className="bg-gradient-to-b from-white-300 to-white-500 w-full mb-12 grid justify-items-center" id="book">
